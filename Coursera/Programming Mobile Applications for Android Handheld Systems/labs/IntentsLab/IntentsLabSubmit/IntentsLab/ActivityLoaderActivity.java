...
public class ActivityLoaderActivity extends Activity {
	...
	private void startExplicitActivation() {
		...
		// 2DO - Create a new intent to launch the ExplicitlyLoadedActivity class

        Intent explicitIntent = new Intent(this, ExplicitlyLoadedActivity.class);

		// 2DO - Start an Activity using that intent and the request code defined above
	...
	private void startImplicitActivation() {
		...
		// 2DO - Create a base intent for viewing a URL
		...
		Intent chooserIntent = baseIntent.createChooser(baseIntent,"View URL Using");
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		// 2DO Process the result only if this method received both a
